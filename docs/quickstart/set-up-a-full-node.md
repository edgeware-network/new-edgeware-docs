...
:::info
To quickly run node from **Docker** image: [https://hub.docker.com/repository/docker/depthhoar/edgeware-node](https://hub.docker.com/repository/docker/depthhoar/edgeware-node)
:::
