...
The wiki was started and is maintained by the Edgeware DAO It is an open source project and aims
to be the most extensive resource of knowledge on Edgeware and the Edgeware ecosystem. A large part
of the material currently focuses on Edgeware directly but it is not opposed to covering
...
Otherwise, Edgeware DAO holds the administrative position and final say on the content that is
included.

## How to Contribute

You can contribute to the wiki on the
[edgeware-network/new-edgeware-docs](https://github.com/edgeware-network/new-edgeware-docs). Every page is a
...
Once logged in, you'll be taken to the file on GitHub. Next, click on the pencil icon on the top right of the file; this brings you to the built-in text editor, where you can make your edits directly. When you've completed your changes, you can add any specific details on what was changed
